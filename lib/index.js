...
var TimeSeekSlider = /** @class */ (function (_super) {
    ...
    TimeSeekSlider.prototype.componentDidMount = function () {
        ...
        window.addEventListener('mouseup', function (e) { return _this.setSeeking(false, e); });
        window.addEventListener('touchmove', this.handleTouchSeeking);
        window.addEventListener('touchend', function (e) { return _this.setMobileSeeking(false); });
    };
    TimeSeekSlider.prototype.componentWillUnmount = function () {
        ...
        window.removeEventListener('mouseup', function (e) { return _this.setSeeking(false, e); });
        window.removeEventListener('touchmove', this.handleTouchSeeking);
        window.removeEventListener('touchend', function (e) { return _this.setMobileSeeking(false); });
    };
